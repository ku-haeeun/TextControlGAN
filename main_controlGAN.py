import argparse
#from controlGAN_real_data import Trainer
from controlGAN import Trainer
from test2 import Tester

def get_args_parser():
    parser = argparse.ArgumentParser()

    parser.add_argument('--isTraining', type=str, required=False, default=True, help='True for training, False for testing')

    # Train options
    parser.add_argument('--dataset_path', type=str,
                        default='/home/haen1012/workspace/Text_to_Image_final_code/Data/Birds_dataset/text2image/birds.hdf5',
                        help='hdf5 file for train')
    parser.add_argument('--checkpoint_dir', default='checkpoints', help='Directory to save the model')
    parser.add_argument('--output_dir', type=str, default='./output_test_again')


    # Testing options
    parser.add_argument('--model_dir', type=str,
                        default='/home/haen1012/workspace/Text_to_Image_final_code/checkpoints/',
    ...
    parser.add_argument('--beta1', type=float, default=0., help='Beta1 hyperparam for Adap optimizers')
